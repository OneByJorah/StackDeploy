...
# Optional: set OBSIDIAN_VAULT_PATH (default: /home/j1admin/ObsidianVault)
...
| Variable | Purpose |
|---|---|
| `SERVER_IP` | Tailscale or local IP used in docs/examples |
...
For local Obsidian usage, open the vault folder `/home/j1admin/ObsidianVault` in your Obsidian desktop app. No separate service is required — Hermes reads and writes markdown notes directly via the Obsidian skill.
